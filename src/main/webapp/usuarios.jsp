...
<div class="modal fade" id="exampleModals" tabindex="-1" aria-labelledby="exampleModalLabels" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabels">IMPRIMIR DATOS USUARIOS</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="eliminar" action="#" method="post">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding" style="background-color: #E0E6EF; padding: 15px;">
                <form action="#" method="get" class="form-horizontal" id="form">
                    <h5 class="text-center" style="font-size: 24px; font-family: 'Arial Black', Arial, sans-serif;"><b>Formulario Usuarios</b></h5>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" onkeypress="return validarTexto(event)" name="nombre" id="nombre" placeholder="Ingrese el nombre" />
                        </div>
                        <div class="form-group">
                            <label for="clave">Clave</label>
                            <input type="password" class="form-control" onkeypress="return validarClave(event)" name="clave" id="clave" placeholder="Ingrese la clave" />
                        </div>
                    </div>
                    ...
                    <div class="form-group text-center">
                        ...
                        <select class="form-control" name="personales" id="personales"></select>
                    </div>
            ...
            <div class="listado-columna">
                <div class="listado" style="background-color: #B3C6E7; padding: 20px;">
                    <h5 class="text-center">
                        ...
                        <a href="listadousuarios.jsp" class="ms-2 text-decoration-none" title="Imprimir" target="_blank">LISTADO  <i class="fas fa-print"></i></a>
                    </h5>
...
<script>
    function validarTexto(event) {
        ...
        if (teclado !== "" && !/^[A-Za-z\s]*$/.test(teclado) && tecla !== 8) { // Allow backspace
            e.preventDefault();
            return false;
        }
        return true;
    ...
    function validarClave(event) {
        ...
        if (!/^[0-9a-zA-Z]*$/.test(teclado) && tecla !== 8) { // Allow backspace
            e.preventDefault();
            return false;
        }
    ...
    function validarRucs(event) {
        ...
        if ((isNaN(teclado) && teclado !== "-") && tecla !== 8) { // Allow backspace
            e.preventDefault();
            return false;
        }

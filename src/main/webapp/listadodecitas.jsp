        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Atender CITA</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="modal-body">
                        <p>¿Estás seguro de que deseas atender la cita?</p>
                        <input type="hidden" name="idpk" id="idpk">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>
                        <button type="button" class="btn btn-primary" name="atender-cita" id="atender-cita" data-bs-dismiss="modal">Si</button>
                    </div>
                </div>
        ...
        <div class="col-md-13 ">
            ...
            <div class="listado-columna">
                <div class="listado" style="background-color: #B3C6E7; padding: 20px;">
                   <h1 style="font-size: 22px; text-align: center; font-family: 'Arial Black', Arial, sans-serif;">Listado de Citas</h1>

                    <div class="table-responsive">
                        <button type="button" onclick="location.href = 'citas.jsp'" class="btn btn-primary">Nueva Cita</button><br></br>

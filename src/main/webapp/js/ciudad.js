$(document).ready(function () {
    listadociudad(); // Función para cargar inicialmente el listado de síntomas
    ...
    $("#botondep").on('click', function () {
        ...
        if (validarFormulario()) {
            ...
            $.ajax({
                ...
                url: 'jsp/ciudad.jsp', // URL del archivo JSP para manejar los síntomas
                type: 'post',
...
$("#imprimirtodo").on('click', function () {
    ...
    $.post('guardarPkimp.jsp', { pkimp: pkimp }, function() {
        ...
        window.open('reporteciudad.jsp', '_blank');
    });
}); 
...
function rellenarciudad(id, nom) {
...
function validarFormulario() {
    ...
    if (nombre === "") {
        mostrarAlerta("Por favor, complete el nombre de la ciudad.", "alert-danger");
        return false;
    } else {
        return true;
    }

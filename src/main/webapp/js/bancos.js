...
$(document).ready(function () {
    listadobanco(); // Función para cargar inicialmente el listado de síntomas
    ...
    $("#botondep").on('click', function () {
        ...
        if (validarFormulario()) {
            ...
            $.ajax({
                ...
                url: 'jsp/bancos.jsp', // URL del archivo JSP para manejar los síntomas
                type: 'post',
...
$("#imprimirtodo").on('click', function () {
    ...
    $.post('guardarPkimp.jsp', { pkimp: pkimp }, function() {
        ...
        window.open('reportebancos.jsp', '_blank');
    });
}); 
...
function rellenarbancos(id, nom) {
...
function validarFormulario() {
    ...
    if (nombre === "") {
        mostrarAlerta("Por favor, complete el nombre del banco.", "alert-danger");
        return false;
    } else {
        return true;
    }

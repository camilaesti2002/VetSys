...
$(document).ready(function () {
    listadometodo(); // Función para cargar inicialmente el listado de síntomas
    ...
    $("#botondep").on('click', function () {
        ...
        if (validarFormulario()) {
            ...
            $.ajax({
                ...
                url: 'jsp/metodo.jsp', // URL del archivo JSP para manejar los síntomas
                type: 'post',
...
$("#imprimirtodo").on('click', function () {
    ...
    $.post('guardarPkimp.jsp', { pkimp: pkimp }, function() {
        ...
        window.open('reportemetodo.jsp', '_blank');
    });
}); 
...
function rellenarmetodo(id, nom) {
...
function validarFormulario() {
    ...
    if (nombre === "") {
        mostrarAlerta("Por favor, complete el nombre del metodo.", "alert-danger");
        return false;
    } else {
        return true;
    }

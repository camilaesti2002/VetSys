...
<script src="js/informeventa.js"></script>
...
<div class="card" style="background: #B3C6E7;">
                    <div class="card-body">
                        <h2 class="card-title text-center">DATOS DEL INFORME RESUMIDO</h2> <!-- Título centrado -->
                        <form id="form">
                            ...
                            <div class="row"> <!-- Fila con dos columnas -->
                                <div class="col-md-6"> <!-- Columna izquierda -->
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="numero" id="numero" onkeypress="return validarNumeroFactura(event)" placeholder="Ingrese el numero" onpaste="bloquearPegado(event)">
                                    </div>
                                </div>
                                <div class="col-md-6"> <!-- Columna derecha -->
                                    <div class="form-group">
                                        <label for="nombre">CONDICION</label>
                                        <select class="form-control" name="condicion" id="condicion" style="width: 100%;" >
                            ...
                            <div class="row"> <!-- Fila con dos columnas -->
                                ...
                                <div class="col-md-6"> <!-- Columna derecha -->
                                    <div class="form-group">
                                        <label for="departamento">Clientes</label>
